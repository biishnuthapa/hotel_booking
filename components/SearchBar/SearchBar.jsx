      ...
      <div className="flex flex-col lg:mr-[10px] lg:ml-[20px] border-r-0 lg:border-r-2 lg:border-[#C7C6C1]">
        ...
        <div className="relative">
          ...
          {isLocationDropdownOpen && (
            <div className="dropdown-content absolute bg-white shadow-lg rounded-lg mt-1 left-0" ref={dropdownRef}>
      ...
      <div className="flex flex-col  lg:mr-[10px] lg:ml-[20px] mt-4 lg:mt-0 border-[#ccc] lg:border-r-0">
        ...
        <div className="relative">
          ...
          {isGuestsDropdownOpen && (
            <div className="dropdown-content absolute bg-white shadow-lg rounded-lg mt-1 right-0" ref={dropdownRef}>
              <div className="flex flex-col px-4 py-2">
                <AddGuests
